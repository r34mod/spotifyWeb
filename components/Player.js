...
import { FastForwardIcon, PlayIcon, ReplyIcon, SwitchHorizontalIcon } from "@heroicons/react/outline";
    ...
    return (
        <div className="h-24 bg-gradient-to-b from-black to-gray-900
            ...
            <div className="flex items-center justify-evenly">
                ...
                {isPlaying ? (
                        <PauseIcon onClick={handlerPlayPause} className="button w-10 h-10" />)
                    : (
                        <PlayIcon onClick={handlerPlayPause} className="button w-10 h-10" />
                    )
                }
